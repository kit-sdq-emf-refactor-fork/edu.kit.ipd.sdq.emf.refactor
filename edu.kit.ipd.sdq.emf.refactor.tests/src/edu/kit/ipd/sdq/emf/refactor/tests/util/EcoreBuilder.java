...
public class EcoreBuilder {
     ...
     * 
     * @param context
     *            EClass, where to add the attribute.
     * @param name
     ...
     * 
     * @param context
     *            EClass, where to add the reference.
     * @param name
     *            Name of the reference.
     * @param type
     *            Type of the reference.
     * @param containment
     *            Is this reference a containment?
     * @param lowerBound
     * @param upperBound
     */
     ...
     * 
     * @param context
     *            EEnum, where to add the literal.
     * @param name
     *            Name of the literal.
     * @param value
     ...
     * 
     * @param context
     *            EClass, where the supertype is added.
     * @param superTypePackage
     *            EPackage which contains the supertype
     * @param className
     *            Name of supertype
     */
